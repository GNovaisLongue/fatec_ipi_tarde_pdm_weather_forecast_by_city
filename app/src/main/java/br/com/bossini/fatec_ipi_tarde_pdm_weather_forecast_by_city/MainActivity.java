    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String urlService = getString(R.string.web_service_url);
                String endereco =
                        urlService + cidade + "&units=metric&APPID=" + api; //"&units=metric&APPID="
                Toast.makeText(
                        MainActivity.this,
                        endereco,
                        Toast.LENGTH_SHORT
...
//                                reader.readLine();
                                ...
                                e.printStackTrace();
                                runOnUiThread(//toast estava fora da main thread
                                        () -> Toast.makeText(
                                                MainActivity.this,
